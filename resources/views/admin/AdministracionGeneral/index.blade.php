        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div class="space-y-4">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <a href="{{ url('/admin/Usuarios') }}" class="group flex items-center gap-4 p-4 rounded-2xl border border-gray-100 shadow-sm transition-all duration-300 hover:bg-blue-50 hover:shadow-md hover:-translate-y-1 hover:border-blue-200">
            ...
            <div class="space-y-4">
                ...
                <div class="flex flex-col gap-3">
                    <a href="{{ url('admin/Caja') }}" class="group flex items-center gap-4 p-4 rounded-2xl border border-gray-100 shadow-sm transition-all duration-300 hover:bg-emerald-50 hover:shadow-md hover:-translate-y-1 hover:border-emerald-200">
