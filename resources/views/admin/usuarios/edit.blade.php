...
<div class="w-full px-0 sm:px-6 animate-fade-in text-slate-700 space-y-6">
    ...
    <form action="{{ route('admin.Usuarios.update', $usuario->id) }}" method="POST" enctype="multipart/form-data" class="w-full">
        @csrf
        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
                            <div class="space-y-1.5 w-full">
                                ...
                                <div class="relative flex items-center w-full">
                                    ...
                                    <input type="text" name="dni" value="{{ old('dni', $usuario->dni) }}" placeholder="Ej: 72654321" class="w-full pl-11 pr-4 py-3 bg-white border border-slate-200 rounded-xl text-sm focus:border-sky-400 focus:ring-4 focus:ring-sky-500/5 transition-all outline-none">
                                </div>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 pt-5 mt-1 border-t border-slate-100 w-full">
                            ...
                            <div class="space-y-1.5 w-full">
                                <label class="text-[11px] font-bold text-slate-800 uppercase ml-1">
                                    Contraseña <span class="text-slate-400 normal-case font-normal block sm:inline">(opcional)</span>
                                </label>
                                <div class="relative flex items-center w-full">
