                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="space-y-1.5">
                                ...
                                <div class="relative flex items-center">
                                    ...
                                    <input type="text" name="dni" placeholder="Ej: 72654321" class="w-full pl-11 pr-20 py-3 bg-white border border-slate-200 rounded-xl text-sm focus:border-sky-400 focus:ring-4 focus:ring-sky-500/5 transition-all outline-none">
